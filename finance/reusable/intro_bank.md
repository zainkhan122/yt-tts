# Opens actually used (log, not a menu)

Do not pick the next open from this table. Pick it from `sources.md`, then check it is not a sibling.

| Film | What the record gave us | Open we used |
|---|---|---|
| E01 MoviePass | 3 million → dark | name-first stamp |
...
| E08 Circuit City | 625 stores opened late 5 Feb 2003 | late-opening / firing first |
